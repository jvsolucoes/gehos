/*
	...
	Possui integra��o com o Menu e requer o fun��es do m�dulo de Menu fmMenu (menu.js).
	Requer o jquery.
	
	** Para fazer: Criar uma vers�o que n�o depende do jquery.
*/

fmTabCount = 0;

/**
 * Abre uma nova aba. Ao carregar um m�dulo em uma nova aba, o carregador de m�dulos chama a fun��o javascript init_nomedomodulo onde
 * nomedomodulo � o nome do arquivo que gera o m�dulo. OBS: A extens�o do nome do m�dulo � removida no nome da fun��o. Por exemplo,
 * fmTabNew('geral','cadatroEmpresa.php'); carrega o m�dulo mGeral/cadastroEmpresa.php e chama a sua fun��o init_cadastroEmpresa();
 * 
 * @author Dimas Melo Filho
 * @param  system A qual subsistema pertence o m�dulo que ser� carregado na aba. Pode ser: geral, homecare, hospital, clinca, consultorio.
 * @param  modulo Nome do arquivo (dentro da pasta de subsistema) que gera o c�digo do m�dulo. 
 */
 ...
 *
 * @author Dimas Melo Filho
 * @param  tabId N�mero da aba que deve ser exibida.
 */
...
/**
 * Fecha uma aba e remove seus componentes do formul�rio.
 *
 * @author Dimas Melo Filho
 * @param  tabId N�mero da aba que deve ser exibida.
 */
